...
from amber.language_model.initialization import create_from_huggingface
...
class TestHuggingFaceIntegration:
    ...
    @patch('amber.language_model.initialization.AutoTokenizer')
    @patch('amber.language_model.initialization.AutoModelForCausalLM')
    ...
    def test_dataset_loading_from_hub(self, mock_model_class, mock_tokenizer_class, temp_store):
        ...
        with mock_patch("amber.datasets.text_dataset.load_dataset") as mock_load:
