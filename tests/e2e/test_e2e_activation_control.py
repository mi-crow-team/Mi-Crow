...
def test_e2e_activation_control_amplification():
    ...
    SCALE_FACTOR = 2.0
    controller = SimpleActivationController(LAYER_SIGNATURE, scale_factor=SCALE_FACTOR, hook_id="test_amplifier")
...
def test_e2e_activation_control_with_controllers_parameter():
    ...
    controller = ActivationCapturingController(LAYER_SIGNATURE, hook_id="test_capturer")
    hook_id = model.layers.register_hook(LAYER_SIGNATURE, controller)
