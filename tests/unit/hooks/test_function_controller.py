...
class TestFunctionControllerInitialization:
    ...
    def test_init_with_function(self):
        ...
        controller = FunctionController(layer_signature="layer_0", function=scale_by_two)
    ...
    def test_init_with_hook_type(self):
        ...
        controller = FunctionController(layer_signature="layer_0", function=identity, hook_type=HookType.PRE_FORWARD)
    ...
    def test_init_with_custom_hook_id(self):
        ...
        controller = FunctionController(layer_signature="layer_0", function=identity, hook_id="custom_id")
...
class TestFunctionControllerModifyActivations:
    ...
    def test_modify_activations_forward_hook(self):
        ...
        controller = FunctionController(layer_signature="layer_0", function=scale_by_two, hook_type=HookType.FORWARD)
    ...
    def test_modify_activations_pre_forward_hook(self):
        ...
        controller = FunctionController(layer_signature="layer_0", function=add_one, hook_type=HookType.PRE_FORWARD)
        module = nn.Linear(10, 5)
        input_tensor = torch.randn(2, 10)
    ...
    def test_modify_activations_none_tensor(self):
        ...
        controller = FunctionController(layer_signature="layer_0", function=identity)
        module = nn.Linear(10, 5)
    ...
    def test_modify_activations_function_returns_non_tensor_raises_error(self):
        ...
        controller = FunctionController(layer_signature="layer_0", function=return_string)
        module = nn.Linear(10, 5)
        output_tensor = torch.randn(2, 5)
    ...
    def test_modify_activations_function_exception_raises_error(self):
        ...
        controller = FunctionController(layer_signature="layer_0", function=failing_function)
        module = nn.Linear(10, 5)
        output_tensor = torch.randn(2, 5)
...
class TestFunctionControllerIntegration:
    ...
    def test_function_controller_with_linear_layer(self):
        ...
        controller = FunctionController(layer_signature="layer_0", function=clamp_activations)
        module = nn.Linear(10, 5)
        input_tensor = torch.randn(2, 10)
        output_tensor = torch.randn(2, 5) * 5.0
        result = controller.modify_activations(module, input_tensor, output_tensor)
        assert result is not None
    ...
    def test_function_controller_with_lambda(self):
        ...
        controller = FunctionController(layer_signature="layer_0", function=lambda x: x * 0.5)
        module = nn.Linear(10, 5)
        output_tensor = torch.randn(2, 5)
    ...
    def test_function_controller_modifies_tuple_output_in_place(self):
        ...
        controller = FunctionController(layer_signature="layer_0", function=add_one, hook_type=HookType.FORWARD)
        module = nn.Linear(10, 5)
        input_tensor = torch.randn(2, 10)
        output_tensor = torch.randn(2, 5)
    ...
    def test_function_controller_modifies_object_with_last_hidden_state(self):
        ...
        controller = FunctionController(
            layer_signature="layer_0", function=multiply_by_three, hook_type=HookType.FORWARD
        )
        module = nn.Linear(10, 5)
        input_tensor = torch.randn(2, 10)
