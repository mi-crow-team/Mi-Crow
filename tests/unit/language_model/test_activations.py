...
from amber.datasets import BaseDataset, LoadingStrategy
...
class TestLanguageModelActivations:
    ...
    def test_process_batch_empty_texts(self, mock_language_model):
    ...
    def test_process_batch_with_texts(self, mock_language_model):
    ...
    def test_convert_activations_to_dtype(self, mock_language_model):
        ...
        detector1 = Mock()
        detector1.tensor_metadata = {
            "activations": torch.tensor([1.0, 2.0], dtype=torch.float32)
        }
        detector2 = Mock()
    ...
    def test_save_activations_dataset_with_max_length(self, mock_language_model, temp_store):
        ...
        assert "tok_kwargs" in call_kwargs or len(mock_language_model._inference_engine.execute_inference.call_args[0]) > 0
