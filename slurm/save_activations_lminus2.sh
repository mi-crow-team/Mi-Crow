...
#SBATCH --mem=24G
#SBATCH --gres=gpu:1
#SBATCH --job-name=save-activations-l-2
...
# Model configurations with layers shifted by -2 (comparison study)
declare -A MODEL_LAYERS
MODEL_LAYERS["meta-llama/Llama-3.2-3B-Instruct"]=25
MODEL_LAYERS["speakleash/Bielik-1.5B-v3.0-Instruct"]=29
MODEL_LAYERS["speakleash/Bielik-4.5B-v3.0-Instruct"]=57
...
echo ""
echo "========================================================================"
echo "All activations saved successfully (L-2 layers)!"
echo "========================================================================"
