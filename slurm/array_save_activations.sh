...
#SBATCH -c 4
#SBATCH --mem=36G
#SBATCH --job-name=array-save-activations
#SBATCH --array=0-5
...
echo ""
echo "========================================================================"
echo "Task $SLURM_ARRAY_TASK_ID: Processing $MODEL on $DATASET (layer $LAYER_NUM)"
echo "========================================================================"
echo ""
...
echo ""
echo "✅ Task $SLURM_ARRAY_TASK_ID completed: $MODEL on $DATASET"
echo ""
