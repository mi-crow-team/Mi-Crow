...
#SBATCH --mem=24G
#SBATCH --gres=gpu:1
#SBATCH --job-name=save-activations-prefixed
...
# Datasets to process (including test splits for evaluation)
DATASETS=("wgmix_train" "wgmix_test" "plmix_train" "plmix_test")

# Process all combinations of models and datasets with prefix forcing
for MODEL in "${!MODEL_LAYERS[@]}"; do
  LAYER_NUM=${MODEL_LAYERS[$MODEL]}
  
  echo ""
  echo "========================================================================"
  echo "Processing model: $MODEL (layer $LAYER_NUM) WITH PREFIX"
  echo "========================================================================"
  
  for DATASET in "${DATASETS[@]}"; do
    echo ""
    echo ">>> Dataset: $DATASET (prefixed)"
    echo ""
    ...
    echo ""
    echo "✅ Completed: $MODEL on $DATASET (prefixed)"
    echo ""
  done
done
...
echo ""
echo "========================================================================"
echo "All prefixed activations saved successfully!"
echo "========================================================================"
