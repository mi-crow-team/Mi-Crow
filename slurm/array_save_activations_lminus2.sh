...
# 3 models × 2 datasets = 6 tasks (indices 0-5)
MODELS=(
...
# Layers shifted by -2 from default
LAYERS=(
  25
  25
  29
...
echo ""
echo "========================================================================"
echo "Task $SLURM_ARRAY_TASK_ID: Processing $MODEL on $DATASET (layer $LAYER_NUM, L-2)"
echo "========================================================================"
echo ""
...
echo ""
echo "✅ Task $SLURM_ARRAY_TASK_ID completed: $MODEL on $DATASET (L-2)"
echo ""
